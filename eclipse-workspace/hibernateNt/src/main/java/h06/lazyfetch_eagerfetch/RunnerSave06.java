...
public class RunnerSave06 {
	...
	public static void main(String[] args) {
		 ...
		 * Advantages of LAZY FETCH:
		 ...
		 2)Loading too much unnecessary data might impact performance and memory badly should type "fetch=FetchType.EAGER" 
		 INTO @OneToMany() or @MantToOne()
		 3)If yoyu type "fetch=FetchType.EAGER" into @OneToMany() all fetches will behave like Eager Fetch
		 ...
		 Note:1)Hibernate works in Lazy Fetch as default
		 	2)To convert Lazy Fetch to Eager Fetch you	
