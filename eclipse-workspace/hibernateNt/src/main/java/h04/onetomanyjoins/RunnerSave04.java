...
public class RunnerSave04 {
	...
	public static void main(String[] args) {
		...
		/*
		 * Note: In OneToMany relationship, Parent Class can have multiple children but
		 * Child Class cannot have multiple parents. So, A stduent can have multiple
		 * books, but a book cannot have multiple studnet owners. If you try to add
		 * multiple owner for a book, Hibernate does not give any error, it just accepts
